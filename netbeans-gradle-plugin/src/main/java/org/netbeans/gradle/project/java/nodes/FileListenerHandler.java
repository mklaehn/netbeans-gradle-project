...
public class FileListenerHandler {
    ...
    private final ChangeListenerManager changedListener = new GenericChangeListenerManager();
    private final FileChangeListener fileChangeListener = new FileChangeAdapter() {
        ...
        public void fileRenamed(final FileRenameEvent fe) {
            if (null == fe.getExt() || fe.getExt().isEmpty()) {
                ...
                LOGGER.log(Level.INFO, "Folder {0}.{1} has been renamed.", new Object[]{fe.getName(), fe.getExt()});
            }
